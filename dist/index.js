...
var _initialiseProps = function _initialiseProps() {
  ...
  this.ReactComponent = function () {
    ...
    var language = componentProps.language ? _languages2.default[componentProps.language] || _languages2.default['en'] : _languages2.default['en'];

    return _react2.default.createElement(_view2.default, _extends({}, componentProps, { language: language, controller: _this2 }));
  };
};
...
var BraftFinderView = function (_React$Component) {
  ...
  function BraftFinderView(props) {
    ...
    _this.changeListenerId = _this.controller.onChange(function (items) {
      _this.setState({
        items: items,
        confirmable: items.find(function (_ref3) {
...
exports.default = {
  ...
  externalInputTip: 'Split source name and source URL with "|", THIS IS VIDEO | Example: <iframe width="560" height="315" src="https://www.youtube.com/embed/0suSWZMBBwg" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>',
